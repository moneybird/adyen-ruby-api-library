...
RSpec.describe Adyen::BalancePlatform, service: "Balance Platform service" do
  ...
  context "paymentInstruments" do
    it "updates a payment instrument" do
      ...
      url = client.service_url("BalancePlatform", "paymentInstruments/#{paymentInstrumentId}", "1")
      WebMock.stub_request(:patch, url).
        with(
          body: request_body,
          headers: {
      ...
      result = client.balance_platform.update_payment_instrument(request_body, paymentInstrumentId)
      response_hash = result.response
    ...
    it "gets a payment instrument" do
      ...
      result = client.balance_platform.get_payment_instrument(paymentInstrumentId)
      response_hash = result.response
